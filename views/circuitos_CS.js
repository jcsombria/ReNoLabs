...
function Control(_topFrame,_libraryPath,_codebasePath, _inputParameters) {
...
var lab = new LabInstance("147.96.67.54", "80");lab.connect();
  ...
  var mu; // EjsS Model.Variables.Lab Variables.mu
  var sigma; // EjsS Model.Variables.Lab Variables.sigma
  ...
  _model._readParameters = function(json) {
    ...
    if(typeof json.mu != "undefined") mu = json.mu;
    if(typeof json.sigma != "undefined") sigma = json.sigma;
  ...
  _model.addToReset(function() {
    ...
    mu = 0; // EjsS Model.Variables.Lab Variables.mu
    sigma = 1; // EjsS Model.Variables.Lab Variables.sigma
  });
  ...
  _model.addToEvolution(function() {
    ...
    } catch(e) {  // > Evolution.Evol Page:15
      time = 0;  // > Evolution.Evol Page:16
      ref = 0;  // > Evolution.Evol Page:17
      u = 0;  // > Evolution.Evol Page:18
      output = 0;  // > Evolution.Evol Page:19
  ...
  function _selectView(_viewNumber) {
    _view = null;
    _view = new Control_View(_topFrame,_viewNumber,_libraryPath,_codebasePath);
  ...
  _view.slider.setDisabled(false);
  ...
  _view.plottingPanel2.getController().setWorldYMax(0);
          ...
          _view.labFunctionParameterReference.linkProperty("Lab",  function() { return lab; }, function(_v) { lab = _v; } ); // HtmlView Page linking property 'Lab' for element 'labFunctionParameterReference'
          _view.labFunctionParameterController.linkProperty("Lab",  function() { return lab; }, function(_v) { lab = _v; } ); // HtmlView Page linking property 'Lab' for element 'labFunctionParameterController'
...
function Control_View (_topFrame,_viewNumber,_libraryPath,_codebasePath) {
  var _view;
  switch(_viewNumber) {
    case -10 : break; // make Lint happy
    default :
    case 0: _view = Control_View_0 (_topFrame); break;
  } // end of switch
  ...
  _view._addDescriptionPage('Intro Page','./Control_Intro_1.html');

  return _view;
} // end of main function

function Control_View_0 (_topFrame) {
  ...
  _view._reset = function() {
    ...
    _view._addElement(EJSS_INTERFACE.imageAndTextButton,"topLabel", _view.labelPanel) // EJsS HtmlView.HtmlView Page: declaration of element 'topLabel'
      .setProperty("Text","<h1>Práctica de Control de Sistemas</h1>") // EJsS HtmlView.HtmlView Page: setting property 'Text' for element 'topLabel'
      ;
    ...
    _view._addElement(EJSS_DRAWING2D.plottingPanel,"plottingPanel1", _view.subPanel1) // EJsS HtmlView.HtmlView Page: declaration of element 'plottingPanel1'
      ...
      .setProperty("Title","Consigna (azul), Control (verde), Salida (rojo)") // EJsS HtmlView.HtmlView Page: setting property 'Title' for element 'plottingPanel1'
    ...
    _view._addElement(EJSS_INTERFACE.panel,"controlPanel", _view.threePanelsPanel) // EJsS HtmlView.HtmlView Page: declaration of element 'controlPanel'
      .setProperty("Width",800) // EJsS HtmlView.HtmlView Page: setting property 'Width' for element 'controlPanel'
      .setProperty("CSS",{"padding-top":"30px", "display":"flex" }) // EJsS HtmlView.HtmlView Page: setting property 'CSS' for element 'controlPanel'
      ;

    _view._addElement(EJSS_INTERFACE.panel,"panel6", _view.controlPanel) // EJsS HtmlView.HtmlView Page: declaration of element 'panel6'
      ;

    _view._addElement(EJSS_INTERFACE.imageAndTextButton,"topLabel2", _view.panel6) // EJsS HtmlView.HtmlView Page: declaration of element 'topLabel2'
      .setProperty("Text","<h2>Consigna</h2>") // EJsS HtmlView.HtmlView Page: setting property 'Text' for element 'topLabel2'
      ;

    _view._addElement(EJSS_INTERFACE.RENOLABS.labFunctionParameter,"labFunctionParameterReference", _view.panel6) // EJsS HtmlView.HtmlView Page: declaration of element 'labFunctionParameterReference'
      .setProperty("RowHeight","20px") // EJsS HtmlView.HtmlView Page: setting property 'RowHeight' for element 'labFunctionParameterReference'
      .setProperty("ColumnWidth","80px") // EJsS HtmlView.HtmlView Page: setting property 'ColumnWidth' for element 'labFunctionParameterReference'
      .setProperty("Config","reference") // EJsS HtmlView.HtmlView Page: setting property 'Config' for element 'labFunctionParameterReference'
      .setProperty("Width",380) // EJsS HtmlView.HtmlView Page: setting property 'Width' for element 'labFunctionParameterReference'
      ;
    ...
    _view._addElement(EJSS_INTERFACE.imageAndTextButton,"topLabel22", _view.panel7) // EJsS HtmlView.HtmlView Page: declaration of element 'topLabel22'
      .setProperty("Text","<h2>Control</h2>") // EJsS HtmlView.HtmlView Page: setting property 'Text' for element 'topLabel22'
      ;

    _view._addElement(EJSS_INTERFACE.RENOLABS.labFunctionParameter,"labFunctionParameterController", _view.panel7) // EJsS HtmlView.HtmlView Page: declaration of element 'labFunctionParameterController'
      .setProperty("RowHeight","20px") // EJsS HtmlView.HtmlView Page: setting property 'RowHeight' for element 'labFunctionParameterController'
      .setProperty("ColumnWidth","80px") // EJsS HtmlView.HtmlView Page: setting property 'ColumnWidth' for element 'labFunctionParameterController'
      .setProperty("Config","controller") // EJsS HtmlView.HtmlView Page: setting property 'Config' for element 'labFunctionParameterController'
      .setProperty("Width",380) // EJsS HtmlView.HtmlView Page: setting property 'Width' for element 'labFunctionParameterController'
      ;

    _view._addElement(EJSS_INTERFACE.panel,"panel5", _view.threePanelsPanel) // EJsS HtmlView.HtmlView Page: declaration of element 'panel5'
      ;

    _view._addElement(EJSS_INTERFACE.RENOLABS.labControl,"labControl", _view.panel5) // EJsS HtmlView.HtmlView Page: declaration of element 'labControl'
  ...
  return _view;
      ...
      window.addEventListener('load',
        function () { 
          _model =  new Control("_topFrame","_ejs_library/",null);
